...
/**
 * Inline brand-social SVGs. lucide-react removed logo icons (trademark), so
 * we ship minimal, recognizable marks here. Keyed by the social `name` used
 * in data/content.ts.
 */
...
export function TwitterIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function FacebookIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function YoutubeIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function InstagramIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function PinterestIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function TiktokIcon({ size = 15, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
