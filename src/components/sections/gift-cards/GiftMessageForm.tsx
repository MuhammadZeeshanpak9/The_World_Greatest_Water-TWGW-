  ...
  return (
    <section className="bg-white py-24 md:py-32">
      <div className="mx-auto max-w-[600px] px-6 text-center">
        <h2 className="font-cormorant text-[36px] text-ink md:text-[48px] text-glow-violet">
      ...
      <m.div
        ...
        viewport={{ once: true }}
        className="mx-auto mt-10 max-w-[600px] rounded-[24px] glass-card-light p-8  md:p-12"
      >
        {status === "success" ? (
